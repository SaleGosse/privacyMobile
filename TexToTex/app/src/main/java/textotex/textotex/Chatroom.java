...
public class Chatroom extends AppCompatActivity {
    ...
    public void changgeBackground()
    {
        ...
        name.concat(String.valueOf(randomNum));
        LinearLayout ll = findViewById(R.id.ChatRoom);
        Resources res = getResources();
        Drawable drawable = res.getDrawable(R.drawable.bridge);
        if(ll == null )
        {
            ll.setBackgroundResource(R.drawable.bridge);
        }
        switch(randomNum)
        {
            case 0:
